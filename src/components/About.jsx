            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                    ...
                    <div className="bg-cream/50 p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="w-12 h-12 bg-deep-purple/10 rounded-full flex items-center justify-center mb-6 text-deep-purple">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                        </div>
                        <h3 className="text-xl font-bold text-deep-purple mb-4">{t.about.mission.title}</h3>
                    ...
                    <div className="bg-cream/50 p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                        ...
                        <h3 className="text-xl font-bold text-deep-purple mb-4">{t.about.vision.title}</h3>
                    ...
                    <div className="bg-cream/50 p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                        ...
                        <h3 className="text-xl font-bold text-deep-purple mb-4">{t.about.values.title}</h3>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 max-w-4xl mx-auto">
                    <div className="md:flex">
                        ...
                        <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                            <div className="uppercase tracking-wide text-sm text-deep-purple font-semibold mb-2">{t.about.role}</div>
                            ...
                            <div className="mt-8">
                                <div className="flex items-center space-x-4">
                                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">ISO 9001</span>
